...
async def get_problem_details(request: Request, problem_id: str):
    ...
    return templates.TemplateResponse("problem.html", {"request": request, "problem_id": problem_id, "problem": problem})
...
if __name__ == "__main__":
    ...
    print("Submissions are saved in ./submissions and plagiarism is auto-checked.")
    print("=" * 50)
